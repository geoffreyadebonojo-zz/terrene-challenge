...
RSpec.describe 'Items API', type: :request do
  ...
  describe 'GET /v2/todos/:todo_id/items' do
    before { get "/v2/todos/#{todo_id}/items", headers: headers }
  ...
  describe 'POST /v2/todos/:todo_id/items' do
    let(:valid_attributes) { { name: 'Visit Narnia', done: false }.to_json }

    context 'when request attributes are valid' do
      before { post "/v2/todos/#{todo_id}/items", params: valid_attributes, headers: headers }
    ...
    context 'when an invalid request' do
      before { post "/v2/todos/#{todo_id}/items", params: {}, headers: headers }
